...
const owner: IOwner = new Owner("Рябец", "Олеська", "Валерьна", new Date(), Docs.PASSPORT, 324444124, 244444);
...
const owner1: IOwner = new Owner("Каштан", "Дуб", "Подосинович", new Date(), Docs.POLIC, 23525, 325765);
...
const v1: IVehicle = new Vehicle("и3", "Мур", 2010, 242, 21421, owner1);
const v2: IVehicle = new Vehicle("sos", "Мяу", 2025, 2134, 124, owner1);
...
const v5: IVehicle = new Vehicle("SoS", "ЭсОЭс", 2019, 3333, 313333, owner);
